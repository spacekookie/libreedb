...
%description
An AES encrypt/decrypt gem built ontop of OpenSSL.  Not as quick as FastAES,
but it doesn't require building
...
%changelog
* Thu May 21 2015 Katharina Sabel - 0.5.0-1
- Creating the initial package from RubyGems for the latest available version.
