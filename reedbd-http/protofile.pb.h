...
#ifndef PROTOBUF_protofile_2eproto__INCLUDED
#define PROTOBUF_protofile_2eproto__INCLUDED
...
class Person_PhoneNumber : public ::google::protobuf::Message {
 ...
 private:
  ...
  ::std::string* number_;
  int type_;
  friend void  protobuf_AddDesc_protofile_2eproto();
  friend void protobuf_AssignDesc_protofile_2eproto();
  friend void protobuf_ShutdownFile_protofile_2eproto();
...
#endif  // PROTOBUF_protofile_2eproto__INCLUDED
