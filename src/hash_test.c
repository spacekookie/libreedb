 ...
 * Copyright (C) 1998-2015 Nicolas Darnis <ndarnis@free.fr>
 *
...
static gdsl_element_t my_struct_alloc(void* d)
{
	static int n = 0;
...
static void my_struct_free(gdsl_element_t e)
{
...
static void my_struct_printf(gdsl_element_t e, FILE* file,
		gdsl_location_t location, void* d)
{
	my_struct s = (my_struct) e;
